...
const closeBtn = document.getElementsByClassName("wb-close").enable
const genesis = document.getElementById("genesis")
const genesisContent = document.querySelector('#genesis-content')



function disableGenesis() {
